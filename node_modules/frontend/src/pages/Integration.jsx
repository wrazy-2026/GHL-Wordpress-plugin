...
export default function Integration() {
    ...
    useEffect(() => {
        ...
        setLocationLink(localStorage.getItem('ghl_locationLink') || '')
    }, [])
    ...
    const save = () => {
        ...
        localStorage.setItem('ghl_locationLink', locationLink)
        alert('Saved')
    }
    ...
    return (
        <div>
            ...
            <div className="max-w-md space-y-4">
                ...
                <div>
                    <label className="block text-sm font-medium">Subaccount Location Link (for live preview)</label>
                    <input value={locationLink} onChange={e => setLocationLink(e.target.value)} placeholder="https://yoursubaccount.gohighlevel.com" className="mt-1 block w-full border rounded p-2" />
                    <p className="text-xs text-gray-500 mt-1">Used to generate live preview links in Watch page</p>
                </div>
                <div>
